...
["paul", "taylor", "adele"].challenge39() //should return ["taylor", "adele", "paul"].
[String]().challenge39() //should return [].
...
/*:
 ...
 Then your method should return  [7, 21, 26], because those are the numbers missing from the array.
...
func challenge40(array: [Int]) -> [Int] {
    var temp = Set(1...100)
    //formSymmetricDifference returns the elements which are in temp but missing in input array!
    temp.formSymmetricDifference(Set(array))
    return Array(temp)
}

var testArray = Array(1...100)
testArray.remove(at: 6)
challenge40(array: testArray)
